...
{/* <div class="gambar-container">
    <img class="gambar" src="./poster_belneg.png">
    <div class="detail">
        <div class="title">
            <span class="namaGambar">-</span>
        </div>
        <div class="likeSection">
            <i class="belanegara1-image-likes bi bi-heart-fill"></i>
            <span class="likeImageCount">0</span>
        </div>
    </div>
    <div class="komen">
        <div class="lihatKomen">
            <div class="tampilKomenGambar">Lihat <span class="jumlahKomenGambar1">0</span> Komen</div>
            <div class="sembunyiKomenGambar" style="display: none;">Sembunyikan <span class="jumlahKomenGambar2">0</span> Komen</div>
        </div>
        <ul class="daftarKomen daftarKomenGambar"></ul>
        <form class="tambahKomen tambahKomenGambar">
            <input
                required
                class="isiKomen"
                type="text"
                ...
                autocomplete="off"
            >
            <button class="kirimKomen kirimKomenGambar" type="submit" name="kirim-komen-gambar">Kirim</button>
        </form>
    </div>
</div> */}
